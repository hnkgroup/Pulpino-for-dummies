...
create_clock -period 25.000 -name ref_clk -waveform {0.000 5.000} -add [get_ports CLK_100]

create_clock -period 250.000 -name jtag_clk -waveform {0.000 5.000} -add [get_ports TCK]

# define false paths between all clocks
set_clock_groups -asynchronous -group ref_clk -group jtag_clk
...
##Pmod Headers
###########################
## GPIO[7:0] Pmod Header JA (standard)
...
## JTAG/UART Pmod Header JD (standard)
